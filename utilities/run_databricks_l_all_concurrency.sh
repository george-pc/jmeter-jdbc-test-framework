#!/bin/bash
# Run all Databricks Large (L) cluster concurrency tests sequentially
...
echo -e "${BLUE}=========================================="
echo "Databricks Large (L) Cluster - All Concurrency Tests"
echo -e "==========================================${NC}"
echo ""
echo "⚠️  IMPORTANT: Ensure Databricks warehouse is set to LARGE (L) size before running!"
echo ""
echo "Tests to run:"
...
echo "     s3://e6-jmeter/jmeter-results/engine=databricks/cluster_size=L/benchmark=tpcds_29_1tb/"
