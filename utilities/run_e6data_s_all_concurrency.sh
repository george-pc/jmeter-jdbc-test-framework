#!/bin/bash
# Run all e6data Small (S) cluster concurrency tests sequentially
...
echo -e "${BLUE}=========================================="
echo "e6data Small (S) Cluster - All Concurrency Tests"
echo -e "==========================================${NC}"
echo ""
echo "⚠️  IMPORTANT: Ensure e6data cluster is configured for SMALL (S) workload before running!"
echo ""
echo "Tests to run:"
...
echo "     s3://e6-jmeter/jmeter-results/engine=e6data/cluster_size=S/benchmark=tpcds_29_1tb/"
