#!/bin/bash
# Run all e6data Large (L) cluster concurrency tests sequentially
...
echo -e "${BLUE}=========================================="
echo "e6data Large (L) Cluster - All Concurrency Tests"
echo -e "==========================================${NC}"
echo ""
echo "⚠️  IMPORTANT: Ensure e6data cluster is configured for LARGE (L) workload before running!"
echo ""
echo "Tests to run:"
...
echo "     s3://e6-jmeter/jmeter-results/engine=e6data/cluster_size=L/benchmark=tpcds_29_1tb/"
