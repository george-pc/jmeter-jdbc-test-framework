...
echo "     s3://e6-jmeter/jmeter-results/engine=e6data/cluster_size=S-2x2/benchmark=tpcds_29_1tb/"
echo "  2. Compare with Databricks S-2x2 results:"
...
echo "     ./utilities/compare_engines_concurrency.sh S-2x2 S-2x2 tpcds_29_1tb markdown > comparison_60cores.md"
echo ""
