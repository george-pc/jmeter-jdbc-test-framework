#!/bin/bash
# Run all Databricks Small (S) cluster concurrency tests sequentially
...
echo -e "${BLUE}=========================================="
echo "Databricks Small (S) Cluster - All Concurrency Tests"
echo -e "==========================================${NC}"
echo ""
echo "⚠️  IMPORTANT: Ensure Databricks warehouse is set to SMALL (S) size before running!"
echo ""
echo "Tests to run:"
...
echo "     s3://e6-jmeter/jmeter-results/engine=databricks/cluster_size=S/benchmark=tpcds_29_1tb/"
