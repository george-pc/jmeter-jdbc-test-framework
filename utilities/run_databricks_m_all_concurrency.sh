#!/bin/bash
# Run all Databricks Medium (M) cluster concurrency tests sequentially
...
echo -e "${BLUE}=========================================="
echo "Databricks Medium (M) Cluster - All Concurrency Tests"
echo -e "==========================================${NC}"
echo ""
echo "⚠️  IMPORTANT: Ensure Databricks warehouse is set to MEDIUM (M) size before running!"
echo ""
echo "Tests to run:"
...
echo "     s3://e6-jmeter/jmeter-results/engine=databricks/cluster_size=M/benchmark=tpcds_29_1tb/"
